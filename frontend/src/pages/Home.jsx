...
const Home = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const delivered =
        data.donationsByStatus.find((s) => s._id === "DELIVERED")?.count || 0;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            A centralized, location-based platform connecting generous donors
            with passionate volunteers. Real-time tracking, gamified rewards,
            and community impact at your fingertips.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-16">
            <Link
              to="/donor/login"
              className="px-5 py-2 bg-orange-500/20 text-orange-300 rounded-full text-sm font-medium hover:bg-orange-500/30 transition border border-orange-500/30"
            >
              🎁 Donor Portal
            </Link>
            <Link
              to="/volunteer/login"
              className="px-5 py-2 bg-green-500/20 text-green-300 rounded-full text-sm font-medium hover:bg-green-500/30 transition border border-green-500/30"
            >
              🤝 Volunteer Portal
            </Link>
            <Link
              to="/organization/login"
              className="px-5 py-2 bg-blue-500/20 text-blue-300 rounded-full text-sm font-medium hover:bg-blue-500/30 transition border border-blue-500/30"
            >
              🏢 Organization Portal
            </Link>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Addressing critical challenges in donation management and
              community support
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-800/50 backdrop-blur border border-red-500/30 rounded-2xl p-8 hover:border-red-500/50 transition">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                40% of food produced globally is wasted while millions go
                hungry. We bridge this gap by connecting surplus food with those
                in need.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur border border-orange-500/30 rounded-2xl p-8 hover:border-orange-500/50 transition">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Donors often don't know where their contributions go. Our
                real-time tracking and verified deliveries ensure complete
                transparency.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur border border-yellow-500/30 rounded-2xl p-8 hover:border-yellow-500/50 transition">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Manual coordination between donors and volunteers is
                inefficient. Our location-based matching automates and optimizes
                the process.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl p-8 hover:border-green-500/50 transition hover:bg-slate-800/80">
              ...
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                Share surplus food, clothing, or essentials. Create donation
                listings and track their journey from pickup to delivery.
              </p>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex items-center gap-2">
                  <span className="text-green-500">✓</span> Post donations
                  anytime
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500">✓</span> Track live delivery
                  status
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500">✓</span> See your impact
                  metrics
                </li>
              </ul>
            </div>
            ...
            <div className="group bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl p-8 hover:border-emerald-500/50 transition hover:bg-slate-800/80">
              ...
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                Accept delivery tasks in your area, earn points, and climb the
                leaderboard. Make a direct impact in your community.
              </p>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-500">✓</span> Choose tasks near
                  you
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-emerald-500">✓</span> Build your
                  reputation
                </li>
              </ul>
            </div>
            ...
            <div className="group bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl p-8 hover:border-teal-500/50 transition hover:bg-slate-800/80">
              ...
              <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                NGOs and community groups can manage large-scale campaigns,
                coordinate multiple volunteers, and amplify impact.
              </p>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex items-center gap-2">
        ...
        {/* Impact Statistics */}
        <div
          className="grid md:grid-cols-4 gap-6 mt-20 mb-20"
          style={{ display: "none" }}
        >
          ...
          {[
            {
              ...
              description:
                "Connect with donors and volunteers in your area instantly",
            ...
            },
            {
              ...
              description:
                "Track donations from pickup to delivery with live GPS tracking",
            ...
            },
            {
              ...
              description:
                "Earn points and climb the leaderboard for your contributions",
              gradient: "from-teal-500 to-cyan-600",
            },
          ].map((feature, idx) => (
            <div
              key={idx}
              className="group bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl p-8 hover:border-green-500/50 transition hover:bg-slate-800/80"
            >
              <div
                className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-3xl mb-4 group-hover:scale-110 transition shadow-lg`}
              >
                {feature.icon}
              </div>
